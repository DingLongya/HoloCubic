...
![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/git_2.png)

下面就是输入命令下载项目了，找到源项目的 github 地址，进入进去点击 Code 会发现有一个 ssh 地址，将它复制出来。

![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/github_1.png)
...
![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/3.png)
...
![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/4.png)
...
![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/6.png)

点击`Reports`中的`Bill of Materials`后，最后点击`Export`保存到指定位置就可以查看了。

![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/7.png)

同理，输出 MainBoard.PcbDoc 的元件也是同样的操作。

![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/8.png)

至此，我们已经能找到两个板子的 PCB 图，能够找到所要购买的元件表。元件的购买可以去日常网购软件，也可以去嘉立创去买，下面是我总结的元件表，以及在嘉立创购买的价格，仅供参考。

![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/1.png)

![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/9.png)

### PCB 板的打印

PCB 板的打印我选择的是嘉立创，PCB 在线下单，也是通过朋友推荐的，因为以前没有打印过 PCB 板。嘉立创对新手好像有几次的免费打印，嘿嘿，主要是想白嫖啦！哈~ 只需要按照要求提交 2 个 PCB 板的电路图，就可以了。

![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/2.png)

这个网站感觉好高级，可以看到制作的实时进度，而且在公众号可以看到生产车间的直播，第一次打板子，感觉好高级的亚子。

![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/10.png)

### 焊接工具的购买

因为以前自己没有焊过电路板，所以没有这些工具，简单的购买了一些必要的东西，大家可以参考一下。

![contents](https://github.com/DingLongya/HoloCubic/blob/main/images/5.png)
